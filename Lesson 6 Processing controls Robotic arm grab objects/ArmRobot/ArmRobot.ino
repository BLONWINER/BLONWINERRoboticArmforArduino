...
void loop() {
  ...
  do{
    ...
    if (moveServoData == 101) {//e
      ...
      closeLock=false;
      servo5Angle++;
      if(servo5Angle>=180){servo5Angle=180;}
    ...
    if (moveServoData == 114) {//r
      ...
      closeLock=false;
      servo5Angle--;
      if(servo5Angle<=0){servo5Angle=0;}
      servo5.write(servo5Angle);
    }
    if(moveServoData == 113) {//q 
      ...
      closeLock=false;
      servo4Angle++;
      if(servo4Angle>=90){servo4Angle=90;}
    ...
    if(moveServoData == 119) {//w
      ...
      closeLock=false;
      servo4Angle--;
      if(servo4Angle<=35){servo4Angle=35;}
      servo4.write(servo4Angle);
    }
