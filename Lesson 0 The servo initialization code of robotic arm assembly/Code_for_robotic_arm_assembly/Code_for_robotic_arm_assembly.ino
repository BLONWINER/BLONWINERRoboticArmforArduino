/***********************************************************
File name: Code_for_robotic_arm_assembly.ino
Description: Power on, the servo rotates 90 to straighten the robotic arm (This code is used for robotic arm assembly)
